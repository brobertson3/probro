...
//      /*TODO Inside here is where
//      * 1. Set up the edit text views for task and time
//      * 2. Add those values to the database w/ the createTask method
//      * 3. Return Tasks objects from createTasks() to the original fragment*/
